...
// Simple hack to get access to the functions
code += `
global.getStaffRosterForAdmin = typeof getStaffRosterForAdmin !== 'undefined' ? getStaffRosterForAdmin : null;
global.saveStaffMemberAdmin = typeof saveStaffMemberAdmin !== 'undefined' ? saveStaffMemberAdmin : null;
global.deleteStaffMemberAdmin = typeof deleteStaffMemberAdmin !== 'undefined' ? deleteStaffMemberAdmin : null;
global.bulkUpsertStaffRoster = typeof bulkUpsertStaffRoster !== 'undefined' ? bulkUpsertStaffRoster : null;
`;

eval(code);

console.log("--- Testing getStaffRosterForAdmin ---");
let roster = global.getStaffRosterForAdmin();
...
global.saveStaffMemberAdmin({name: 'Charlie', email: 'charlie@example.com', duty: '3'});
roster = global.getStaffRosterForAdmin();
...
global.saveStaffMemberAdmin({originalEmail: 'alice@example.com', name: 'Alice M', email: 'alice.m@example.com', duty: '1B'});
roster = global.getStaffRosterForAdmin();
...
global.deleteStaffMemberAdmin('bob@example.com');
roster = global.getStaffRosterForAdmin();
